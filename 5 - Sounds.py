...
def main():
    ...
    (step, step2, swoosh, hurt, deadmonster, hitmonster,
     hitmonster2, healthup, died, won, music) = load_sounds()
    ...
    sky = pg.image.load('Assets/Textures/skybox2.jpg')
    ...
    while running:
        ...
        enemies, player_health, mape = enemies_ai(posx, posy, enemies, maph, size, mape, swordsp,
                                                  ticks, player_health)
...
def load_sounds():
    ...
    step2 = pg.mixer.Sound('Assets/Sounds/enemystep.mp3')
    swoosh = pg.mixer.Sound('Assets/Sounds/sword.mp3')
    hurt = pg.mixer.Sound('Assets/Sounds/damage.mp3')
    deadmonster = pg.mixer.Sound('Assets/Sounds/deadmonster.mp3')
    hitmonster = pg.mixer.Sound('Assets/Sounds/hitmonster.mp3')
    hitmonster2 = pg.mixer.Sound('Assets/Sounds/hitmonster2.mp3')
    healthup = pg.mixer.Sound('Assets/Sounds/healthup.wav')
    died = pg.mixer.Sound('Assets/Sounds/died.wav')
    won = pg.mixer.Sound('Assets/Sounds/won.wav')
    music = pg.mixer.Sound('Assets/Sounds/battlemusic0.mp3')
